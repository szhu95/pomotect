...
const Sounds = () => {
    ...
    return (
        <div>
            ...
            <Soundcloud title_href="https://soundcloud.com/pomotect" title="pomotect" label="DOWN TEMPO [2 of ?]" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1761435171&color=%233100ff&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true" />
