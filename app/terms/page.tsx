                        ...
                        <div>
                            ...
                            <div className="WordSection1">
                                <p className="MsoNormal">
                                    <b>
                                        <span style={{ fontSize: "13.0pt", fontFamily: '"Arial",sans-serif' }}>
                                ...
                                <p className="MsoNormal">
                                    ...
                                    >
                                        We are POSTMODERN TECTONICS, doing business as POMO—TECT TM ("
                                    </span>
                                    <b>
                                        <span
                                            style={{
                                ...
                                <p className="MsoNormal">
                                    ...
                                    >
                                        "), and POSTMODERN TECTONICS, concerning your access to and use of the
                                ...
                                <p className="MsoNormal">
                                    ...
                                    >
                                        ...
                                        seven (7) days after the notice is given, except if the changes apply to
                                        security updates, in which case the changes will be effective
                                        immediately. By continuing to use the Services after the effective date
                                        of any changes, you agree to be bound by the modified terms. If you
                                ...
                                <p className="MsoNormal">
                                    ...
                                    >
                                        ...
                                        20. USER DATA
                                        <br />
                                        21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 22.
                                ...
                                <p className="MsoNormal" style={{ background: "white" }}>
                                    ...
                                    >
                                        ...
                                        address your request to: office@pomotect.com. If we ever grant you the
                                ...
                                <p className="MsoNormal" style={{ background: "white" }}>
                                    ...
                                    >
                                        ...
                                        Services. Make any unauthorized use of the Services, including
                                ...
                                <p className="MsoNormal" style={{ background: "white" }}>
                                    ...
                                    <b>
                                        ...
                                        >
                                            We collect basic personal information that you provide when purchasing
                                            an item from POMO—TECT TM. We won't share your data with any third
                                            parties. That's whack.
                                        </span>
                                    </b>
                                    <span
                                        style={{
                                ...
                                <p className="MsoNormal" style={{ background: "white" }}>
                                    ...
                                    >
                                        ...
                                        OR PARTICIPATION IN THE SERVICES OR DELETE ANY CONTENT OR INFORMATION
                                ...
                                <p className="MsoNormal" style={{ background: "white" }}>
                                    ...
                                    >
                                        ...
                                        applicable law, the arbitration will take place in Manhattan, New York.
                                ...
                                <p className="MsoNormal" style={{ background: "white" }}>
                                    ...
                                    >
                                        ...
                                        courts located in Manhattan, New York, and the Parties hereby consent
                                ...
                                <table
                                    ...
                                    cellSpacing={0}
                                    cellPadding={0}
                                    style={{ background: "#00307A", borderCollapse: "collapse" }}
                                >
                                    <tbody>
                                        <tr>
                                            <td
